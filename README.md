...
|---------------------|---------------------|--------------|
| Comunica oralmente sus ideas y/o resultados con objetividad a público de diferentes especialidades y niveles jerárquicos, en el marco del desarrollo de un proyecto en ingeniería. | **De La Cruz Villarreal, Carlos Alejandro**  <br> **TB1**: Participación en las reuniones de equipo. <br> Interacción con stakeholders. <br> **TP**: Colaboración constante en las tareas de equipo por parte del Front End <br> Terminado de las tareas asignadas <br> **Justo Yauricasa, Alexander Paolo**  <br> **TB1**: Participación en las reuniones y cordinacion del equipo. <br> Interacción con expertos en el tema. <br> **TP**: Colaboración constante en las tareas de equipo por parte del Front End <br> Terminado de las tareas asignadas <br> **Conde Isla Camila Alessandra**  <br> **TB1**: Participación en las reuniones de equipo. <br> Interacción con stakeholders. <br>   **TP**: Colaboración constante en las tareas de equipo por parte del Front End <br> Terminado de las tareas asignadas <br> **Jara Benites  Quique Vladimir**  <br> **TB1**: Participación en las reuniones de equipo. <br> Interacción con stakeholders. <br> **TP**: Colaboración constante en las tareas de equipo por parte del Front End <br> Terminado de las tareas asignadas <br> **Vera Nuñez Nicolas Alejandro**  <br> **TB1**: Participación en las reuniones de equipo. <br> Interacción con stakeholders. <br> **TP**: Colaboración constante en las tareas de equipo por parte del Front End <br> Terminado de las tareas asignadas <br> **TF**: Lideró la integración entre el backend y la base de datos MySQL. <br> Presentación de resultados del backend al equipo y stakeholders. <br> Coordinó la implementación de endpoints críticos para la gestión de usuarios y cursos. <br>   | **TB1**: En conclusión, en este primer entregable hemos iniciado con nuestra investigación para apoyar a las comunidades rurales y los guías locales a poder contactar con potenciales clientes como pueden ser los turistas. A su vez, ya tenemos el primer prototipo de nuestra landing page, como a su vez hemos iniciado con las descripción de funcionalidades de nuestra aplicación web. <br> **TP**: En conclusión, en este trabajo parcial hemos desarrollado la primera parte del Front End y la segunda parte de nuestro Landing Page. A su vez hemos empezado a prepararnos para el proximo entregable <br> **TF**: En conclusión, el desarrollo del backend con MySQL permitió consolidar la arquitectura del sistema, asegurando una integración eficiente con el frontend y sentando las bases para futuras extensiones del proyecto. |
| Comunica en forma escrita ideas y/o resultados con objetividad a público de diferentes especialidades y niveles jerárquicos, en el marco del desarrollo de un proyecto en ingeniería. |  **De La Cruz Villarreal, Carlos Alejandro**  <br> **TB1**:Elaboración de Informes <br>  Elaboración de documentación técnica. <br> **TP**: Elaboración del Sprint 2 junto con las asignaciones correspondientes para este entregable <br> **Justo Yauricasa, Alexander Paolo**  <br> **TB1**Elaboración de Informes. <br> Elaboración de documentación técnica. <br>  **TP**: Elaboración del Sprint 2 junto con las asignaciones correspondientes para este entregable <br> **Conde Isla Camila Alessandra**  <br> **TB1**:Elaboración de Informes <br>  Elaboración de documentación técnica. <br> **TP**: Elaboración del Sprint 2 junto con las asignaciones correspondientes para este entregable <br> **Jara Benites  Quique Vladimir**  <br> **TB1**:Elaboración de Informes <br>  Elaboración de documentación técnica. <br> **TP**: Elaboración del Sprint 2 junto con las asignaciones correspondientes para este entregable <br>  **Vera Nuñez Nicolas Alejandro**  <br> **TB1**:Elaboración de Informes <br>  Elaboración de documentación técnica. <br> **TP**: Elaboración del Sprint 2 junto con las asignaciones correspondientes para este entregable <br> **TF**: Documentación exhaustiva del backend, incluyendo el modelo de base de datos en MySQL y la funcionalidad de las API RESTful. <br> Redacción de las evidencias de prueba y validación del sistema. <br> Creación de guías técnicas para futuras iteraciones y escalabilidad del sistema. <br>  |  **TB1**: En conclusión, la documentación técnica está casi completa, el informe casi completo para esta entrega y el código de la Landing Page funcional y corriendo en cualquier momento del día. <br> **TP**: En conclusión, la documentación esta casi terminada asi como la parte de la aplicación, tambien concluido con el front end y la segunda parte del Landing Page <br> **TF**: En conclusión, la documentación detallada del backend asegura la continuidad del proyecto, permitiendo que futuros desarrolladores comprendan y expandan la funcionalidad del sistema. |
